...
"""Verify that starting nvolved with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nvolved with -h for help text")
        ...
        self.log.info("Start nvolved with -version for version information")
