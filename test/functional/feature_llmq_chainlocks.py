...
from test_framework.test_framework import NvolveTestFramework
...
class LLMQChainLocksTest(NvolveTestFramework):
    def set_test_params(self):
        self.set_nvolve_test_params(6, 5, fast_dip3_enforcement=True)
