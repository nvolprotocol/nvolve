...
This mechanism has been integrated into Bitcore-Node-Nvolve which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nvolprotocol/insight-api-nvolve#web-socket-api](https://github.com/nvolprotocol/insight-api-nvolve#web-socket-api)
* API: [https://github.com/nvolprotocol/insight-api-nvolve#instantsend-transactions](https://github.com/nvolprotocol/insight-api-nvolve#instantsend-transactions)
