...
This document provides guidelines for internationalization of the Nvolve Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nvolve_en.ts` remains unchanged.
