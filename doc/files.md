...
* nvolve.conf: contains configuration settings for nvolved or nvolve-qt
* nvolved.pid: stores the process id of nvolved while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by nvolved or nvolve-qt
