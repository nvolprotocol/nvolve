...
rm -f src/config/nvolve-config.h
...
rm -rf test_bitcoin.coverage/ nvolve-gtest.coverage/ total.coverage/
...
clean_exe src/nvolve-cli
clean_exe src/nvolved
clean_exe src/nvolve-gtest
clean_exe src/nvolve-tx
clean_exe src/test/test_nvolve
clean_exe src/test/test_nvolve_fuzzy
...
clean_dep . src/config/nvolve-config.h.in
