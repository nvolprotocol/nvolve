...
#error Client version information missing: version is not defined by nvolve-config.h or in any other way
#endif
...
/**
 * nvolved-res.rc includes this file, but it cannot cope with real c++ code.
