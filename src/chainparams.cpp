...
{
    const char* pszTimestamp = "Nvolve fastest blockchain protocol combining PoW and PoS with TIER 2 architecture";
    const CScript genesisOutputScript = CScript() << ParseHex("04b1bc62b8975f27a97c6e277cfcd6bbc6f0dd97c467440725975a36bb38787a6cfd876c058bce050d97f094db4ea1047b3012056ab5cf4002a61f5a8f7f9e135b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Nvolve: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Nvolve: 1.5 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x00000807de175e02ffcc791163839445becf5041d8b9639805a39377988a4e93"); // 0
        ...
        genesis = CreateGenesisBlock(1716523204, 785729, 0x1e0ffff0, 2, 2 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe1bc0763c592f830acdecb487e25d4188561de9c34f155f773c1d56e9f46e1c4"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e675cff18c46acacee40bd2f01b7e3e23d564405ae1927fda7395306e07e4df"));

        vSeeds.emplace_back("seed.nvolve.tech");



        // Nvolve addresses start with 'N'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,53);
        // Nvolve script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Nvolve private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Nvolve BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Nvolve BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Nvolve BIP44 coin type is '5'
...
//        }
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 960);
        ...
        vSporkAddresses = {"NNVG4AW2tRrvhdq7HcFnic5AXseUFPkLyu"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1716523204,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Nvolve: 1 day
        consensus.nPowTargetSpacing = 60; // Nvolve: 1 minutes
        ...
        genesis = CreateGenesisBlock(1716523204, 1574, 0x20001fff, 2, 2 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0435a6af9faa796130ba3ed2e2b544dbc419c889e5303186addc86d2c01c9acf"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e675cff18c46acacee40bd2f01b7e3e23d564405ae1927fda7395306e07e4df"));
        ...
        vSeeds.emplace_back("testnet.nvolve.tech");
        //vSeeds.emplace_back("tnet1.nvolve.tech", true);
        //vSeeds.emplace_back("tnet2.nvolve.tech", true);

        // Testnet Nvolve addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Nvolve script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Nvolve BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Nvolve BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Nvolve BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "TNQ4G7uFuL31rSSM1KxVJMd2c4eQQ8y7Sm");
        ...
        chainTxData = ChainTxData{
            1716523204, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Nvolve: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Nvolve: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("nvolveevo.org",  "devnet-seed.nvolveevo.org"));

        // Testnet Nvolve addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Nvolve addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Nvolve script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Nvolve BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Nvolve BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Nvolve BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
