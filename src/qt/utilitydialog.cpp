    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  nvolve-qt [command-line options]                     \n";
...
All the Nvolve in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 NVOL, 0.01 NVOL, 0.1 NVOL, 1 NVOL and 10 NVOL -- sort of like the paper money you use every day.</li> \
