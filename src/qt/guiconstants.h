...
/* NvolveGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* NvolveGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Nvolve"
#define QAPP_ORG_DOMAIN "nvolve.tech"
#define QAPP_APP_NAME_DEFAULT "Nvolve-Qt"
#define QAPP_APP_NAME_TESTNET "Nvolve-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Nvolve-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Nvolve-Qt-regtest"
