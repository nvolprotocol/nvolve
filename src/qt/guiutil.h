...
/** Utility functions used by the Nvolve Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "nvolve:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load nvolve specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a nvolve specific theme is activated (light/dark).*/
