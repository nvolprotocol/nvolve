...
//! Interface for the src/evo part of a nvolve node (nvolved process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a nvolve node (nvolved process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a nvolve node (nvolved process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a nvolve node (nvolved process).
class Node
{
public:
    virtual ~Node() {}
