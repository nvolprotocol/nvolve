Contributing to Nvolve Core
============================

The Nvolve Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nvolprotocol/nvolve/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Nvolve Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Nvolve
Network Protocol consensus changes.

Whether a pull request is merged into Nvolve Core rests with the project merge
...
Patches that change Nvolve consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nvolve consensus, it must have been
...
The review process is normally fairly responsive on the Nvolve Core repository, however
...
The project leader is the release manager for each Nvolve Core release.
